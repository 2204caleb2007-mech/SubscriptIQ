...
<<<<<<< HEAD
      ...
      <motion.div
        ...
        className="mb-8 p-6 rounded-2xl bg-gradient-to-r from-accent/10 to-indigo-500/10 border border-accent/20"
      >
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-xl font-bold mb-2">AI Operations Assistant</h3>
            <p className="text-muted-foreground">
              Our AI has analyzed today's trends. There's a 15% increase in upgrade requests.
              Would you like me to prioritize these tickets for you?
            </p>
          </div>
