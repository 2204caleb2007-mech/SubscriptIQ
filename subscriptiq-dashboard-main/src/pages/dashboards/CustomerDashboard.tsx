...
<<<<<<< HEAD
      ...
      <motion.div
        ...
        className="mb-8 p-4 rounded-xl bg-accent/5 border border-accent/20 flex items-center justify-between"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm">Subscription Optimization</p>
            <p className="text-xs text-muted-foreground">AI suggests switching to Annual billing to save $2,400/year.</p>
          </div>
        </div>
        <Link to="/ai-insights">
